...
prepro_configs = json.load(open('C:/Users/gapbu/Desktop/SW_contest_mindtherapy/Emotion_process/CLEAN_DATA/'+DATA_CONFIGS,'r', encoding='utf-8')) 

#TODO 데이터 경로 설정
with open('C:/Users/gapbu/Desktop/SW_contest_mindtherapy/Emotion_process/CLEAN_DATA/tokenizer.pickle','rb') as handle:
